...
var file_track_proto_rawDesc = []byte{
	...
	0x6f, 0x69, 0x64, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x2f,
	0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2d, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x2f, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_track_proto_goTypes = []interface{}{
	...
	(*TracksRes)(nil),     // 5: track.TracksRes
}
var file_track_proto_depIdxs = []int32{
	4, // 0: track.TracksRes.tracks:type_name -> track.TrackRes
	1, // 1: track.TrackService.Create:input_type -> track.Track
	3, // 2: track.TrackService.Get:input_type -> track.FilterRequest
	2, // 3: track.TrackService.GetByID:input_type -> track.TrackId
	1, // 4: track.TrackService.Update:input_type -> track.Track
	2, // 5: track.TrackService.Delete:input_type -> track.TrackId
	0, // 6: track.TrackService.Create:output_type -> track.Void
	5, // 7: track.TrackService.Get:output_type -> track.TracksRes
	4, // 8: track.TrackService.GetByID:output_type -> track.TrackRes
